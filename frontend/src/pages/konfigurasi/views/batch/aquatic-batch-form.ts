// frontend/src/components/aquatic-batch-form.ts

import { LitElement, html } from 'lit';
import { customElement, property, state } from 'lit/decorators.js';
import type { GenericBatch } from '@models/generic-batch.model';
import { aquaticBatchSchema } from 'src/schema/aquatic.schema';
import './generic-batch-form';

@customElement('aquatic-batch-form')
