  ...
  render() {
    return html`
      <div class="mb-4 flex flex-wrap gap-4 items-end">
        ...
        <!-- End Time -->
        <div class="flex flex-col min-w-[180px]">
          <label class="text-xs font-medium text-gray-600 mb-1">End Time</label>
          <input
            name="filterEnd"
            type="datetime-local"
            class="border border-gray-300 px-3 py-1 rounded text-sm"
        ...
        <div class="flex flex-col">
          ...
          <button
            class="px-3 py-1 text-sm bg-gray-200 hover:bg-gray-300 rounded border border-gray-400"
            ...
            ${this.filteredEvents.map((e) => {
              ...
              return html`
                <tr class="${getRowColor(e.event)} ${highlight}">
                  <td class="px-4 py-2">${this.formatDateTime(e.timestamp)}</td>
