// frontend/src/components/livestock-batch-form.ts

import { LitElement, html } from 'lit';
import { customElement, property, state } from 'lit/decorators.js';
import type { GenericBatch } from '@models/generic-batch.model';
import { livestockBatchSchema } from 'src/schema/livestock.schema';
import './generic-batch-form';

@customElement('livestock-batch-form')
export class LivestockBatchForm extends LitElement {
  createRenderRoot() {
    return this;
  }
  ...
  private async loadMockData() {
    const res = await fetch('/assets/mock/livestock-batches.json');
