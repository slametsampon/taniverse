// frontend/src/repositories/api/ApiLivestockHarvestResultRepository.ts
...
export class ApiLivestockHarvestResultRepository
  implements HarvestResultRepository
{
  private baseUrl = '/api/livestock-harvest-results';
